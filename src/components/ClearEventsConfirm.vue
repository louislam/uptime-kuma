...
export default {
    ...
    mounted() {
        ...
        this.$refs.modalElement.addEventListener("hidden.bs.modal", this.hiddenHandler);
    },
    beforeUnmount() {
        if (this.$refs.modalElement && this.hiddenHandler) {
            this.$refs.modalElement.removeEventListener("hidden.bs.modal", this.hiddenHandler);
        }
        if (this.modal) {
            this.modal.dispose();
            this.modal = null;

<template>
    ...
    <div class="mb-3">
        <label for="internal-room-id" class="form-label">{{ $t("Device Id") }}</label><span style="color: red;"><sup>*</sup></span>
        <input id="internal-room-id" v-model="$parent.notification.deviceId" type="text" class="form-control" required="true">
    </div>
    <div class="mb-3">
        <label for="internal-room-id" class="form-label">{{ $t("User Id") }}</label><span style="color: red;"><sup>*</sup></span>
        <input id="internal-room-id" v-model="$parent.notification.userId" type="text" class="form-control" required="true">
    </div>
    <div class="mb-3">

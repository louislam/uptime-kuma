export default {
    ...
    Degraded: "Degraded",
    "Master Monitors": "Master Monitors",
    monitorDependsOn: "The status of this monitor depends on",
    "Pick Master Monitors...": "Pick Master Monitors...",
    masterMonitorsDescription: "Select the monitor(s) on which this monitor depends. If the master monitor(s) fails, this monitor will be affected too.",

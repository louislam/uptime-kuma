export default {
    ...
    proxyDescription: "Для работы прокси следует назначит его одному из мониторов",
    enableProxyDescription: "Этот прокси не будет влиять на запросы мониторинга, пока он не будет активирован. Вы можете контролировать временное отключение прокси со всех мониторов по статусу активации.",
    setAsDefaultProxyDescription: "Этот прокси был активирован по умолчанию для новых мониторов. Вы можете отключить прокси для каждого отдельного монитора.",
};

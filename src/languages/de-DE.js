export default {
    ...
    Unpin: "Loslösen",
    "Switch to Light Theme": "Zu hellem Theme wechseln",
    "Switch to Dark Theme": "Zu dunklem Theme wechseln",
    ...
    wayToGetClickSendSMSToken: "Sie können den API-Benutzernamen und den API-Schlüssel von {0} erhalten.",
    "Also check beta release": "Prüfe auch die Beta-Version",
    "API Key": "API-Schlüssel",
    "API Username": "API-Benutzername",
    "Certificate Expiry Notification": "Benachrichtigung bei Ablauf eines Zertifikates",
    "Check how to config it for WebSocket": "Prüfen, wie man es für einen WebSocket konfiguriert",
    ...
    "Most likely causes:": "Wahrscheinlichste Ursachen:",
    "Octopush API Version": "Octopush API-Version",
    "PushDeer Key": "PushDeer-Schlüssel",
    "pushoversounds alien": "Alien-Alarm (lang)",
    "pushoversounds bike": "Fahrrad",
    "pushoversounds bugle": "Trompete",
    "pushoversounds cashregister": "Registrierkasse",
    ...
    "pushoversounds intermission": "Unterbrechung",
    "pushoversounds magic": "Magisch",
    "pushoversounds mechanical": "Mechanisch",
    "pushoversounds none": "Keine (still)",
    "pushoversounds persistent": "Dauerhaft (lang)",
    "pushoversounds pianobar": "Piano Bar",
    "pushoversounds pushover": "Pushover (Standard)",
    "pushoversounds siren": "Siren",
    "pushoversounds spacealarm": "Space Alarm",
    "pushoversounds tugboat": "Schlepper",
    "pushoversounds updown": "Aufwärts Abwärts (lang)",
    "pushoversounds vibrate": "Nur Vibration",
    "Recipient Number": "Nummer des Empfängers",
    "Retype the address.": "Adresse erneut eingeben.",
    "Show update if available": "Update anzeigen, falls verfügbar",
    "Steam Game Server": "Steam Spiele-Server",
    ...
    "Using a Reverse Proxy?": "Verwendung eines Reverse-Proxys?",
    "What you can try:": "Was du ausprobierne kannst:",
    octopushAPIKey: "\"API-Schlüssel\" von den HTTP-API-Anmeldeinformationen im Kontrollpanel",
    octopushLogin: "\"Login\" von den HTTP-API-Anmeldeinformationen im Kontrollpanel",
    onebotGroupMessage: "Gruppe",
    onebotHttpAddress: "OneBot HTTP-Adresse",
    onebotMessageType: "OneBot Nachrichten-Typ",
    onebotPrivateMessage: "Privat",
    onebotSafetyTips: "Zur Sicherheit muss ein Zugangs-Token gesetzt werden",
    onebotUserOrGroupId: "Gruppe/Benutzer ID",
    promosmsLogin: "API-Anmeldename",
    promosmsPassword: "API-Passwort",
    Proxy: "Proxy",
    pushyAPIKey: "Geheimer API-Schlüssel",
    pushyToken: "Geräte-Token",
    topicExplanation: "MQTT-Thema zu überwachen",
};

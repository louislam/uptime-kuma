export default {
    ...
    enablebawaanNotificationDescription: "Untuk setiap monitor baru, notifikasi ini akan diaktifkan secara bawaan. Anda masih dapat menonaktifkan notifikasi secara terpisah untuk setiap monitor.",
    ...
    lineDevConsoleTo: "Konsol Pengembang Baris - {0}",
    ...
    aboutMattermostChannelName: "Anda dapat mengganti channel bawaan tujuan posting webhook dengan memasukkan nama channel ke dalam Kolom \"Channel Name\". Ini perlu diaktifkan di pengaturan webhook Mattermost. contoh: #other-channel",
    "matrix": "Matrix",

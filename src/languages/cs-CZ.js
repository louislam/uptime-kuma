export default {
    ...
    enableGRPCTls: "Povolit odesílat požadavky gRPC skrze TLS spojení",
    grpcMethodDescription: "Název metody se převede do formátu cammelCase, například sayHello, check atd.",
    acceptedStatusCodesDescription: "Vyberte stavové kódy, které jsou považovány za úspěšnou odpověď.",
    Maintenance: "Údržba",
    statusMaintenance: "Úds",
    "Schedule maintenance": "Plánování údržby",
    "Affected Monitors": "Dotčené dohledy",
    "Pick Affected Monitors...": "Výběr dotčených dohledů...",
    "Start of maintenance": "Začátek údržby",
    "All Status Pages": "Všechny stavové stránky",
    "Select status pages...": "Vyberte stavové stránky...",
    recurringIntervalMessage: "Spustit jednou denně | Spusti jednou za {0} dní",
    affectedMonitorsDescription: "Select monitors that are affected by current maintenance",
    affectedStatusPages: "Zobrazit tuto zprávy o údržbě na vybraných stavových stránkách",
    ...
    webhookAdditionalHeadersTitle: "Další hlavičky",
    webhookAdditionalHeadersDesc: "Nastaví další hlavičky odeslané webhookem.",
    smtp: "E-mail (SMTP)",
    ...
    Kook: "Kook",
    wayToGetKookBotToken: "Vytvořte si aplikaci a získejte token bota na {0}",
    wayToGetKookGuildID: "Přepněte do 'Vývojářského módu' v nastevení Kook a klikněte pravým tlačítkem pro získání ID skupiny",
    "Guild ID": "ID skupiny",
    line: "Line Messenger",
    ...
    smseagleGroup: "Název skupiny telefonních čísel",
    smseagleContact: "Jméno telefonního kontaktu",
    smseagleRecipientType: "Typ příjemce",
    smseagleRecipient: "Adresát(i) (v případě více než, jednoho odděleni čárkou)",
    smseagleToken: "Přístupový token k API",
    smseagleUrl: "URL vašeho SMSEagle zařízení",
    smseagleEncoding: "Poslat jako Unicode",
    smseaglePriority: "Priorita zpráv (0-9, výchozí = 0)",
    ...
    "Single Maintenance Window": "Jednoduché okno údržby",
  	"Maintenance Time Window of a Day": "Maintenance Time Window of a Day",
  	"Effective Date Range": "Rozsah data účinnosti",
  	"Schedule Maintenance": "Plán údržby",
  	"Date and Time": "Datum a čas",
  	"DateTime Range": "Rozsah data a času",
  	Strategy: "Strategie",
  	"Free Mobile User Identifier": "Identifikátor uživatele Free Mobile",
  	"Free Mobile API Key": "Free Mobile API klíč",
  	"Enable TLS": "Použít TLS",
  	"Proto Service Name": "Proto název služby",
  	"Proto Method": "Proto methoda",
  	"Proto Content": "Proto obsah",
  	Economy: "Economický",
  	Lowcost: "Nízkorozpočtový",
  	high: "vysoký",
  	"General Monitor Type": "Základní typ dohledu",
  	"Passive Monitor Type": "Pasovní dohled",
  	"Specific Monitor Type": "Speciální typ dohledu",
  	dataRetentionTimeError: "Doba uchování musí být 0 nebo vyšší",
  	infiniteRetention: "Pro neomezené uchvávání zadejte 0.",
  	confirmDeleteTagMsg: "Opravdu chcete tuto značku odstranit? Dohledy přiřazené k této značce nebudou odstraněny.",
};

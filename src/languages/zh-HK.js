export default {
    ...
    backupDescription3: "此備份可能包含了一些敏感資料如通知裡的權杖，請小心保存備份。",
    alertNoFile: "請選擇一個檔案",
    alertWrongFileType: "請選擇 JSON 檔案",
    twoFAVerifyLabel: "請輸入你的權杖以驗證 2FA 沒有問題。",
    tokenValidSettingsMsg: "權杖有效！你現在可以把 2FA 設定儲存。",
    confirmEnableTwoFAMsg: "你確定你要開啟 2FA？",
    confirmDisableTwoFAMsg: "你確定你要關閉 2FA ？",
    ...
    retryCheckEverySecond: "每 {0} 秒重試.",
    importHandleDescription: "如果你想略過同名監視器或通知，選擇'略過已存在的'。‘覆蓋’會刪除現有的監視器及通知",
    confirmImportMsg: "你確認你要匯入備份嗎？請確定你選了正確的備份",
    "Heartbeat Retry Interval": "重試脈搏間隔",
    "Import Backup": "匯入備份",
    "Export Backup": "匯出備份",
    ...
    "Keep both": "兩者並存",
    Tags: "標籤",
    "Add New below or Select...": "在以下新增或選擇...",
    "Tag with this name already exist.": "已有標籤使用這名稱",
    "Tag with this value already exist.": "已有標籤使用這值",
    color: "顏色",
    ...
    "Avg. Response": "平均反應時間",
    "Entry Page": "登入畫面",
    statusPageNothing: "沒有任何檢測器或群組，請加入新的檢測器或群組。",
    "No Services": "沒有服務",
    ...
    deleteStatusPageMsg: "是否確定刪除這個狀態頁面？",
    "Push URL": "推送網址",
    ...
    smtpCC: "CC",
    smtpBCC: "BCC",
    "Discord Webhook URL": "Discord 網鉤網址",
    wayToGetDiscordURL: "您可以前往伺服器設定 -> 整合 -> 網鉤 -> 新網鉤以取得",
    "Bot Display Name": "機器人顯示名稱",
    "Prefix Custom Message": "前綴自訂訊息",
    "Webhook URL": "網鉤網址",
    wayToGetTeamsURL: "您可以前往此頁面以了解如何建立網鉤網址 {0}。",
    Number: "號碼",
    Recipients: "收件人",
    ...
    aboutWebhooks: "更多關於網鉤的資訊: {0}",
    aboutChannelName: "如果您不想使用網鉤頻道，請在 {0} 頻道名稱欄位填入您想使用的頻道。例如: #其他頻道",
    ...
    aboutMattermostChannelName: "您可以在 \"頻道名稱\" 欄位中填寫頻道名稱以覆蓋網鉤的預設頻道。必須在 Mattermost 的網鉤設定中啟用。例如：#其他頻道",
    matrix: "Matrix",

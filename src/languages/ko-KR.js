export default {
    ...
    retryCheckEverySecond: "{0}초마다 재확인",
    ...
    notificationDescription: "모니터링에 알림을 설정할 수 있습니다.",
    ...
    resolverserverDescription: "Cloudflare가 기본 서버예요, 원한다면 언제나 다른 Resolver 서버로 변경할 수 있습니다.",
    rrtypeDescription: "모니터링할 RR-Type을 선택해요.",
    pauseMonitorMsg: "정말 이 모니터링을 일시 정지할까요?",
    enableDefaultNotificationDescription: "새로 추가하는 모든 모니터링에 이 알림을 기본적으로 활성화해요. 각 모니터에 대해 별도로 알림을 비활성화할 수 있습니다.",
    ...
    tokenValidSettingsMsg: "토큰이 유효해요! 이제 2단계 인증 설정을 저장할 수 있습니다.",
    ...
    Save: "저장",
    Notifications: "알림",
    "Not available, please setup.": "해당 사항 없음. 설정해주세요.",
    ...
    Logout: "로그아웃",
    Leave: "나가기",
    "I understand, please disable": "알겠습니다, 해제해주세요",
    Confirm: "확인",
    Yes: "확인",
    No: "취소",
    Username: "이름",
    ...
    Heartbeats: "하트비트",
    "Auto Get": "자동 Get",
    backupDescription: "모든 모니터링과 알림을 JSON 파일 형식에 저장할 수 있습니다.",
    ...
    "Tag with this name already exist.": "같은 태그 이름이 이미 존재합니다.",
    "Tag with this value already exist.": "같은 값을 가진 태그가 이미 존재합니다.",
    color: "색상",
    "value (optional)": "값 (선택)",
    Gray: "회색",
    Red: "빨간색",
    ...
    telegram: "Telegram",
    "Bot Token": "봇 토큰",
    wayToGetTelegramToken: "토큰은 여기서 얻을 수 있습니다: {0}.",
    "Chat ID": "채팅 ID",
    supportTelegramChatID: "개인 채팅 / 그룹 / 채널의 ID를 지원합니다.",
    wayToGetTelegramChatID: "봇에 메시지를 보내 채팅 ID를 얻고 밑에 URL로 이동해 chat_id를 볼 수 있습니다.",
    "YOUR BOT TOKEN HERE": "봇 토큰",
    chatIDNotFound: "채팅 ID를 찾을 수 없어요. 먼저 봇에게 메시지를 보내주세요.",
    webhook: "Webhook",
    "Post URL": "Post URL",
    "Content Type": "Content Type",
    webhookJsonDesc: "{0}은 express.js와 같은 최신 HTTP 서버에 적합합니다.",
    webhookFormDataDesc: "{multipart}은 PHP에 적합합니다. {decodeFunction}를 기준으로 json을 디코딩하면 됩니다.",
    smtp: "Email (SMTP)",
    ...
    wayToGetDiscordURL: "서버 설정 -> 연동 -> 웹후크 보기 -> 새 웹후크에서 얻을 수 있습니다!",
    ...
    wayToCheckSignalURL: "밑에 URL을 확인해 URL 설정 방법을 볼 수 있습니다.",
    ...
    pushoverDesc1: "긴급 우선 순위 (2)는 재시도 사이에 기본적으로 30초의 타임아웃이 있고, 1시간 후에 만료됩니다.",
    pushoverDesc2: "다른 장치에 알림을 보내려면 장치칸을 입력해주세요.",
    "SMS Type": "SMS 종류",
    octopushTypePremium: "프리미엄 (빠름) - 알림 기능에 적합해요)",
    octopushTypeLowCost: "저렴한 요금 (느림) - 가끔 차단될 수 있습니다)",
    "Check octopush prices": "{0}에서 Octopush 가격을 확인할 수 있습니다.",
    ...
    "Status:": "상태: {0}",
    "Read more": "더 보기",
    appriseInstalled: "Apprise가 설치되어있습니다.",
    ...
    wayToGetLineChannelToken: "먼저 {0}에 액세스하고, 공급자 및 채널 (Messaging API)을 만든 다음, 각 메뉴 밑에 언급된 메뉴에서 채널 액세스 토큰과 사용자 ID를 얻을 수 있습니다.",
    "Icon URL": "아이콘 URL",
    aboutIconURL: "\"아이콘 URL\"에 사진 링크를 입력해 프로필 사진을 설정할 수 있습니다. 아이콘 이모지가 설정되어 있으면 적용되지 않을 거예요.",
    aboutMattermostChannelName: "채널 이름을 입력하면 Webhook이 게시할 기본 채널을 재설정할 수 있습니다. 이 설정은 Mattermost 웹훅 설정에서 활성화해야 해요. 예: #기타-채널",
    matrix: "Matrix",
    promosmsTypeEco: "SMS ECO - 저렴하지만 느리고 가끔 과부하에 걸려요. 폴란드 수신자만 사용할 수 있습니다. ",
    promosmsTypeFlash: "SMS FLASH - 메시지가 받는 사람 장치에 자동으로 표시됩니다. 폴란드 수신자만 사용할 수 있습니다.",
    ...
    promosmsPhoneNumber: "전화 번호 (폴란드 수신자라면 지역번호를 적지 않아도 됩니다.)",
    ...
    matrixDesc1: "Matrix 클라이언트 방 설정의 고급 섹션에서 내부 방 ID를 찾을 수 있습니다. 내부 방 ID는 이렇게 생겼답니다: !QMdRCpUIfLwsfjxye6:home.server.",
    matrixDesc2: "사용자의 모든 방에 대한 엑세스가 허용될 수 있어서 새로운 사용자를 만들고 원하는 방에만 초대한 후 엑세스 토큰을 사용하는 것이 좋아요. {0} 이 명령어를 통해 엑세스 토큰을 얻을 수 있습니다.",
    Method: "Method",
    Body: "Body",
    Headers: "Headers",
    PushUrl: "Push URL",
    ...
    steamApiKeyDescription: "스팀 게임 서버를 모니터링하려면 Steam Web API 키가 필요해요. API 키는 하단 웹사이트에서 등록할 수 있습니다: ",
    "Current User": "현재 사용자",
    recent: "최근",
    Done: "완료",
    Info: "정보",
    ...
    "Hide Tags": "태그 숨기기",
    Description: "설명",
    "No monitors available.": "모니터가 없습니다.",
    "Add one": "추가하기",
    "No Monitors": "모니터링 없음",
    ...
    dnsPortDescription: "DNS 서버 포트, 기본값은 53 이에요. 포트는 언제나 변경할 수 있습니다.",
    ...
    wayToGetPagerDutyKey: "Service -> Service Directory -> (서비스 선택) -> Integrations -> Add integration. 에서 찾을 수 있습니다. 자세히 알아보려면 {0}에서 \"Events API V2\"를 검색해봐요.",
    ...
    enableProxyDescription: "이 프록시는 활성화될 때까지 영향을 미치지 않아요. 활성화 상태에 따라 모든 모니터에서 프록시를 일시정지할 수 있습니다.",
    setAsDefaultProxyDescription: "새로 추가하는 모든 모니터링에 이 프록시를 기본적으로 활성화해요. 각 모니터에 대해 별도로 프록시를 비활성화할 수 있습니다.",
    ...
    "The current connection may be lost if you are currently connecting via Cloudflare Tunnel. Are you sure want to stop it? Type your current password to confirm it.": "Cloudflare Tunnel를 연결하면 현재 연결이 끊길 수 있습니다. 정말 중지할까요? 비밀번호를 입력해 확인하세요.",
    "Other Software": "다른 소프트웨어",
    "For example: nginx, Apache and Traefik.": "nginx, Apache, Traefik 등을 사용할 수 있습니다.",
    ...
    "Most likely causes:": "가능성 높은 원인:",
    "The resource is no longer available.": "존재하지 않는 자료입니다.",
    "There might be a typing error in the address.": "주소에 오탈자가 있을 수 있습니다.",
    "What you can try:": "해결 방법:",
    "Retype the address.": "주소 다시 입력하기",
    "Go back to the previous page.": "이전 페이지로 돌아가기",
    "Coming Soon": "곧 찾아옵니다...",
    wayToGetClickSendSMSToken: "{0}에서 API 사용자 이름과 키를 얻을 수 있습니다.",
    resendEveryXTimes: "매 {0}회 마다 다시 전송",
    resendDisabled: "재전송 비활성화됨",
    "Heartbeat Timeout": "하트비트 타임아웃",
    timeoutAfterMs: "{0}ms 후 타임아웃",
    "Resend Notification if Down X times consequently": "X회 연속 다운된 경우 알림 재전송",
    "Bark Group": "Bark 그룹",
    "Bark Sound": "Bark 소리",
    "HTTP Headers": "HTTP 헤더",
    "Trust Proxy": "프록시 신뢰",
    HomeAssistant: "홈 어시스턴트",
    RadiusSecret: "Radius 비밀 정보",
    RadiusSecretDescription: "클라이언트와 서버간 공유 비밀 키",
    RadiusCalledStationId: "호출된 스테이션 아이디",
    RadiusCalledStationIdDescription: "호출된 기기 식별자",
    RadiusCallingStationId: "호출한 스테이션 아이디",
    RadiusCallingStationIdDescription: "호출하는 기기 식별자",
    "Connection String": "연결 문자열",
    Query: "쿼리",
    settingsCertificateExpiry: "TLS 인증서 만료",
    certificationExpiryDescription: "TLS 인증서가 다음 안에 만료되는 경우 HTTPS 모니터가 알림을 보냅니다:",
    "Setup Docker Host": "Docker 호스트 설정",
    "Connection Type": "연결 형태",
    "Docker Daemon": "Docker 데몬",
    deleteDockerHostMsg: "모든 모니터에서 이 Docker 호스트를 삭제하시겠습니까?",
    socket: "소켓",
    tcp: "TCP / HTTP",
    "Docker Container": "Docker 컨테이너",
    "Container Name / ID": "컨테이너명 / ID",
    "Docker Host": "Docker 호스트",
    "Docker Hosts": "Docker 호스트들",
    "ntfy Topic": "ntfy 토픽",
    Domain: "도메인",
    Workstation: "워크스테이션",
    disableCloudflaredNoAuthMsg: "현재 비인증 모드이므로, 비밀번호가 필요하지 않습니다.",
    wayToGetLineNotifyToken: "{0}에서 액세스 토큰을 얻을 수 있습니다.",
    Examples: "예제",
    "Home Assistant URL": "홈 어시스턴트 URL",
    "Long-Lived Access Token": "장기 액세스 토큰",
    "Notification Service": "알림 서비스",
    "default: notify all devices": "기본: 모든 기기에 알림",
    "Automations can optionally be triggered in Home Assistant:": "자동화를 홈 어시스턴트에서 선택적으로 동작시킬 수 있습니다.:",
    "Trigger type:": "트리거 유형:",
    "Event type:": "이벤트 유형:",
    "Event data:": "이벤트 데이터:",
    "Then choose an action, for example switch the scene to where an RGB light is red.": "이후 액션을 선택하세요, 예를 들어 RGB 불빛이 적색인 Scene 등으로 교체합니다.",
    "Frontend Version": "프론트엔드 버전",
    "Frontend Version do not match backend version!": "프론트엔드 버전이 백엔드 버전과 맞지 않습니다!",
    "Base URL": "기본 URL",
    goAlert: "GoAlert",
    backupRecommend: "볼륨 또는 데이터 폴더 (./data/) 를 대신 직접 백업해주세요.",
};

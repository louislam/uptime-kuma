export default {
    ...
    "Add New Status Page": "Додати нову сторінку стану",
    Slug: "Slug",
    ...
    "Show update if available": "Показати оновлення, якщо воно доступне",
    "Also check beta release": "Також перевіряти бета-версію",

 ...
 * @param {number} delayMs Delay in milliseconds. Values <= SAFE_MAX_MS behave
 * exactly like a single setTimeout call.
 * @param {number} [chunkMs] Maximum per-chunk timeout. Defaults to SAFE_MAX_MS;
 * exposed for tests so chain behavior can be exercised at small real scales.

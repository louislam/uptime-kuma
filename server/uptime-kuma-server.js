...
class UptimeKumaServer {
    ...
    async getMonitorJSONList(userID, monitorID = null) {
        const { getAccessibleMonitorIDs } = require("./util-server");
        const accessibleIDs = await getAccessibleMonitorIDs(userID);
        ...
        let query = `id IN (${placeholders})`;
        let queryParams = [...accessibleIDs];

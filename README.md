...
- Notifications via Telegram, Discord, Gotify, Slack, Pushover, Email (SMTP), and [90+ notification services, click here for the full list](src/components/notifications)
- 20-second intervals
- [Multi Languages](src/lang)

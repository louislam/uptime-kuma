...
test("expressionOperators", async (t) => {
    await t.test("Test StringEqualsOperator", async (t) => {
    ...
    await t.test("Test StringNotEqualsOperator", async (t) => {
    ...
    await t.test("Test ContainsOperator with scalar", async (t) => {
    ...
    await t.test("Test NotStartsWithOperator", async (t) => {
    ...
    await t.test("Test EndsWithOperator", async (t) => {
    ...
    await t.test("Test NotEndsWithOperator", async (t) => {
    ...
    await t.test("Test NumberEqualsOperator", async (t) => {
    ...
    await t.test("Test GreaterThanOperator", async (t) => {
    ...
    await t.test("Test LessThanOrEqualToOperator", async (t) => {
    ...
    await t.test("Test GreaterThanOrEqualToOperator", async (t) => {
